...
p_206 <- ggplot(data1, aes(x=Pb206.Pb204,y= Pb207.Pb204, color = Region,shape = Region, fill = Region)) +
  ...
  scale_fill_manual(name="",labels = c("Northern Eifel)", "Sauerland","Bergischess Land","Roman object"),values =alpha(c("red","blue", "green","black"),0.8))+
...
Bergischess_Land<-Roman_case[which(Roman_case$Region=="Bergisches Land"),]
...
Bergischess_Land_206v207<-subset(Bergischess_Land, select=c(Pb206.Pb204,Pb207.Pb204))
...
Bergischess_Land_206v208<-subset(Bergischess_Land, select=c(Pb206.Pb204,Pb208.Pb204))
...
Bergischess_Land_206v207_kdh<-ks::kde(Bergischess_Land_206v207,  compute.cont = TRUE,gridsize = 1024)
...
Bergischess_Land_206v207_95<- with(Bergischess_Land_206v207_kdh, contourLines(x=eval.points[[1]], y=eval.points[[2]], z=estimate, levels=cont["5%"]))
Bergischess_Land_206v207_95 <- lapply(Bergischess_Land_206v207_95, data.frame)    
Bergischess_Land_206v207_95 <- purrr::map_dfr(.x=Bergischess_Land_206v207_95, .f=~., .id="group")

Bergischess_Land_206v207_75<- with(Bergischess_Land_206v207_kdh, contourLines(x=eval.points[[1]], y=eval.points[[2]], z=estimate, levels=cont["25%"]))
Bergischess_Land_206v207_75 <- lapply(Bergischess_Land_206v207_75, data.frame)    
Bergischess_Land_206v207_75 <- purrr::map_dfr(.x=Bergischess_Land_206v207_75, .f=~., .id="group")

Bergischess_Land_206v207_50<- with(Bergischess_Land_206v207_kdh, contourLines(x=eval.points[[1]], y=eval.points[[2]], z=estimate, levels=cont["50%"]))
Bergischess_Land_206v207_50 <- lapply(Bergischess_Land_206v207_50, data.frame)    
Bergischess_Land_206v207_50 <- purrr::map_dfr(.x=Bergischess_Land_206v207_50, .f=~., .id="group")
...
Bergischess_Land_206v208_kdh<-ks::kde(Bergischess_Land_206v208,  compute.cont = TRUE,gridsize = 1024)
...
Bergischess_Land_206v208_95<- with(Bergischess_Land_206v208_kdh, contourLines(x=eval.points[[1]], y=eval.points[[2]], z=estimate, levels=cont["5%"]))
Bergischess_Land_206v208_95 <- lapply(Bergischess_Land_206v208_95, data.frame)    
Bergischess_Land_206v208_95 <- purrr::map_dfr(.x=Bergischess_Land_206v208_95, .f=~., .id="group")

Bergischess_Land_206v208_75<- with(Bergischess_Land_206v208_kdh, contourLines(x=eval.points[[1]], y=eval.points[[2]], z=estimate, levels=cont["25%"]))
Bergischess_Land_206v208_75 <- lapply(Bergischess_Land_206v208_75, data.frame)    
Bergischess_Land_206v208_75 <- purrr::map_dfr(.x=Bergischess_Land_206v208_75, .f=~., .id="group")

Bergischess_Land_206v208_50<- with(Bergischess_Land_206v208_kdh, contourLines(x=eval.points[[1]], y=eval.points[[2]], z=estimate, levels=cont["50%"]))
Bergischess_Land_206v208_50 <- lapply(Bergischess_Land_206v208_50, data.frame)    
Bergischess_Land_206v208_50 <- purrr::map_dfr(.x=Bergischess_Land_206v208_50, .f=~., .id="group")
...
k1<-ggplot(data=Roman_object_206v207, aes(x = Pb206.Pb204, y = Pb207.Pb204)) + 
  ...
  geom_polygon(aes(x,y,group=group),data=Bergischess_Land_206v207_95,color="green",fill="green",alpha=0.30) +
  geom_polygon(aes(x,y,group=group),data=Bergischess_Land_206v207_75,color="green",fill="green",alpha=0.20) +
  geom_polygon(aes(x,y,group=group),data=Bergischess_Land_206v207_50,color="green",fill="green",alpha=0.10) +
  ...
  annotate(geom = "text", x = 18.482, y = 15.519, label = "Bergischess Land",size =3, hjust = "left")+
...
k2<-ggplot(data=Roman_object_206v208, aes(x = Pb206.Pb204, y = Pb208.Pb204)) + 
  ...
  geom_polygon(aes(x,y,group=group),data=Bergischess_Land_206v208_95,color="green",fill="green",alpha=0.30) +
  geom_polygon(aes(x,y,group=group),data=Bergischess_Land_206v208_75,color="green",fill="green",alpha=0.20) +
  geom_polygon(aes(x,y,group=group),data=Bergischess_Land_206v208_50,color="green",fill="green",alpha=0.10) +
  ...
  annotate(geom = "text", x = 18.482, y = 38.005, label = "Bergischess Land",size =3, hjust = "left")+
...
Bergischess_Land_1<-subset(Bergischess_Land, select=c(Pb206.Pb204,Pb207.Pb204,Pb208.Pb204,Region))
Roman_object_1<-subset(Roman_object, select=c(Pb206.Pb204,Pb207.Pb204,Pb208.Pb204,Region))
total <- rbind(N_Eifel_1, Sauerland_1,Bergischess_Land_1,Roman_object_1)
...
Bergischess_Land_1<-subset(Bergischess_Land, select=c(Pb206.Pb204,Pb207.Pb204,Pb208.Pb204))
...
Bergischess_Land_H.pi <- Hpi(Bergischess_Land_1,binned=TRUE) ## b is a matrix of x,y,z points
Bergischess_Land_1_kde<-kde(Bergischess_Land_1,H=Bergischess_Land_H.pi)
...
plot(Bergischess_Land_1_kde,display="rgl",cont=c(95),col.fun=colorRampPalette(c('green')), col.pt = 'green',xlab="", ylab="", zlab="",add=TRUE, drawpoints = FALSE, box=FALSE, axes=FALSE)
